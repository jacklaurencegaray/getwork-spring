...
//    @Async // method is executed asynchronously, try2 lng if d mu.refresh ang page ani lol
    List<JobRequest> findAllByCompanyId(Integer companyId);

//    to be continued
    JobRequest findJobRequestByCompanyIdAndId(Integer companyId, Integer id);
